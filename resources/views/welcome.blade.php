...
@section('content')
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <div id="home" class="first-section"
                    style="background-image:url('{{ asset('frontend/images/slider-01.jpg') }}');">
                    <div class="dtab">
                        <div class="container">
                            <div class="row">
            ...
            <div class="carousel-item">
                <div id="home" class="first-section"
                    style="background-image:url('{{ asset('frontend/images/slider-02.jpg') }}');">
                    <div class="dtab">
                        <div class="container">
                            <div class="row">
            ...
            <div class="carousel-item">
                <div id="home" class="first-section"
                    style="background-image:url('{{ asset('frontend/images/slider-03.jpg') }}');">
                    <div class="dtab">
                        <div class="container">
                            <div class="row">
    ...
    {{--  <div id="plan" class="section lb">
        <div class="container">
            <div class="section-title text-center">
                ...
                <p>Berita terbaru di {{ $profilSekolah->nama_sekolah }} </p>
            </div><!-- end title -->
                    ...
                    <div class="col-lg-4 col-md-6 col-12 p-4">
                        <div class="blog-item">
                            <div class="image-blog">
                                <!-- Ganti dengan gambar thumbnail berita jika ada -->
                                {{--  <img src="{{ Storage::url($news->gambar) }}" alt="{{ $news->judul }}" class="img-fluid">  --}}
                                <img src="{{ asset('frontend/images/blog_1.jpg') }}" alt="{{ $news->judul }}"
                                    class="img-fluid">
                            </div>
                            <div class="meta-info-blog">
                                <span><i class="fa fa-calendar"></i> <a
                                        href="#">{{ tanggal_indonesia($news->published_at) }}</a></span>
                                @foreach ($news->kategori as $kategori)
                                    <span><i class="fa fa-tag"></i> <a href="#">{{ $kategori->nama }}</a></span>
                                @endforeach
                                {{--  <span><i class="fa fa-comments"></i> <a href="#">12 Comments</a></span>  --}}
                            </div>
                            <div class="blog-title">
                                <h2><a href="#" title="{{ $news->judul }}">{{ Str::limit($news->judul, 50) }}</a>
                                </h2>
                            </div>
                            <div class="blog-desc">
                                <p style="text-align: justify;">{{ Str::limit($news->isi, 200) }}</p>
                            </div>
                            <div class="blog-button">
                                <a class="hover-btn-new orange" href="#"><span>Baca
                                        Selengkapnya</span></a>
                            </div>
                        </div>
                    </div><!-- end col -->
    ...
    <div id="testimonials" class="parallax section db parallax-off"
        style="background-image:url('{{ asset('frontend/images/parallax_04.jpg') }}');">
        <div class="container">
            <div class="section-title text-center">
                <h3>Testimonials</h3>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="testi-carousel owl-carousel owl-theme">
                        ...
                        <div class="testimonial clearfix">
                            <div class="testi-meta">
                                <img src="{{ asset('frontend/images/testi_03.png') }}" alt=""
                                    class="img-fluid ">
                                <h4>Venanda Mercy </h4>
                            </div>
                            <div class="desc">
        ...
        <div class="container">
            <div class="row logos">
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="{{ asset('frontend/images/logo_01.png') }}" alt=""
                            class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="{{ asset('frontend/images/logo_02.png') }}" alt=""
                            class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="{{ asset('frontend/images/logo_03.png') }}" alt=""
                            class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="{{ asset('frontend/images/logo_04.png') }}" alt=""
                            class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="{{ asset('frontend/images/logo_05.png') }}" alt=""
                            class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="{{ asset('frontend/images/logo_06.png') }}" alt=""
                            class="img-repsonsive"></a>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
